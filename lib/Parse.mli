...
(**
    Functions for parsing swift programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a swift program from a string into a typed OCaml CST.
...
(** Parse a swift program from a file into a typed OCaml CST.
